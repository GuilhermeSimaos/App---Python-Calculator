...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ''
        Entry(width=17, bg='#aabbcc', foreground='black', font=('Arial Bold', 28), textvariable=self.equation).place(x=0, y=0)
        Entry(width=17, bg='#aabbcc', foreground='darkblue', font=('Arial Bold', 28), textvariable=self.result).place(x=0, y=50)
        Button(width=11, height=4, text='(', relief='flat', bg='white', command=lambda: self.show('(')).place(x=0, y=100)
        Button(width=11, height=4, text=')', relief='flat', bg='white', command=lambda: self.show(')')).place(x=90, y=100)
        Button(width=11, height=4, text='%', relief='flat', bg='white', command=lambda: self.show('%')).place(x=180, y=100)
        ...
        Button(width=11, height=4, text='+', relief='flat', bg='white', command=lambda: self.show('+')).place(x=270, y=325)
        Button(width=11, height=4, text='-', relief='flat', bg='white', command=lambda: self.show('-')).place(x=270, y=250)
        Button(width=11, height=4, text='/', relief='flat', bg='white', command=lambda: self.show('/')).place(x=270, y=100)
        Button(width=11, height=4, text='x', relief='flat', bg='white', command=lambda: self.show('*')).place(x=270, y=175)
        Button(width=11, height=4, text='=', relief='flat', bg='white', command=self.solve).place(x=270, y=400)
        Button(width=11, height=4, text='C', relief='flat', bg='lightblue', command=self.clear).place(x=0, y=400)
